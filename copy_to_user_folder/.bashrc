...
# Autocompletation tool Bash Line Editor
source -- ~/.local/share/blesh/ble.sh

# 1. Define the logic in a standard Bash function
sudo_toggle_bash() {
    ...
    # Adjust the cursor position at the end
    READLINE_POINT=${#READLINE_LINE}
}

# 2. Register the function so that Bash recognizes it as an editing command
zle -N sudo_toggle_bash 2>/dev/null || true
bind -x '"\e\e": sudo_toggle_bash'